...
use Chargemap\OCPI\Common\Client\Modules\Sessions\GetListing\GetSessionsListingRequest as BaseRequest;
...
class GetSessionsListingRequest extends BaseRequest
{
    use VersionTrait;
    use ListingRequest;
