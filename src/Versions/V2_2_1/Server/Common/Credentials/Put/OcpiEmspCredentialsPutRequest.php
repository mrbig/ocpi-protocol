...
namespace Chargemap\OCPI\Versions\V2_2_1\Server\Common\Credentials\Put;
...
class OcpiEmspCredentialsPutRequest extends OcpiUpdateRequest
{
    ...
    public function __construct(ServerRequestInterface $request)
    {
        ...
        PayloadValidation::coerce('V2_2_1/Common/Credentials/credentialsPutRequest.schema.json', $this->jsonBody);
