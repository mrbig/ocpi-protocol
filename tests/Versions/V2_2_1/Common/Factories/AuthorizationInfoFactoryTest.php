...
class AuthorizationInfoFactoryTest extends TestCase
{
    ...
    public function testFromJson(string $payload): void
    {
        ...
        OcpiTestCase::coerce('V2_2_1/Common/common.schema.json#/definitions/authorization_info', $json );
    ...
    public static function assertAuthorizationInfo(?stdClass $json, ?AuthorizationInfo $authorizationInfo): void
    {
        if($json === null) {
            ...
            Assert::assertSame($json->authorization_reference ?? null, $authorizationInfo->getAuthorizationReference());
