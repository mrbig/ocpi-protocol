...
use Chargemap\OCPI\Versions\V2_2_1\Common\Factories\EnvironmentalImpactFactory;
...
class EnvironmentalImpactFactoryTest extends TestCase
{
    ...
    public static function assertEnvironmentalImpact(?stdClass $json, ?EnvironmentalImpact $environmentalImpact): void
    {
        if($json === null) {
            ...
            Assert::assertEquals(new EnvironmentalImpactCategory($json->category), $environmentalImpact->getCategory());
