...
use Chargemap\OCPI\Versions\V2_2_1\Common\Factories\RegularHoursFactory;
...
class RegularHoursFactoryTest extends TestCase
{
    ...
    public function testFromJson(string $payload): void
    {
        ...
        OcpiTestCase::coerce('V2_2_1/Common/common.schema.json#/definitions/regular_hours', $json );
