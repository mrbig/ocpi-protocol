...
use Chargemap\OCPI\Versions\V2_2_1\Common\Factories\FloorLevelFactory;
use Chargemap\OCPI\Versions\V2_2_1\Common\Factories\PartialEVSEFactory;
use Chargemap\OCPI\Versions\V2_2_1\Common\Factories\PhysicalReferenceFactory;
...
/**
 * @covers \Chargemap\OCPI\Versions\V2_2_1\Common\Factories\PartialEVSEFactory
 */
class PartialEVSEFactoryTest extends TestCase
{
    ...
    public function testFromJson(string $payload): void
    {
        ...
        OcpiTestCase::coerce('V2_2_1/eMSP/Server/Locations/Evses/evsePatchRequest.schema.json', $json);
