...
/**
 * @covers \Chargemap\OCPI\Versions\V2_2_1\Common\Factories\PartialLocationFactory
 */
class PartialLocationFactoryTest extends TestCase
{
    ...
    public function testFromJson(string $payload): void
    {
        ...
        OcpiTestCase::coerce('V2_2_1/eMSP/Server/Locations/locationPatchRequest.schema.json', $json);
