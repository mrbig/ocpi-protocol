...
namespace Tests\Chargemap\OCPI\Versions\V2_2_1\Server\Emsp\Locations\Evses\Get;

use Chargemap\OCPI\Common\Server\StatusCodes\OcpiSuccessHttpCode;
use Chargemap\OCPI\Versions\V2_2_1\Common\Factories\EVSEFactory;
use Chargemap\OCPI\Versions\V2_2_1\Server\Emsp\Locations\Evses\Get\OcpiEmspEvseGetResponse;
...
/**
 * @covers \Chargemap\OCPI\Versions\V2_2_1\Server\Emsp\Locations\Evses\Get\OcpiEmspEvseGetResponse
 */
class ResponseConstructionTest extends TestCase
{
    ...
    public function testShouldSerializeLocationCorrectlyWithFullPayload(string $payload)
    {
        ...
        OcpiTestCase::coerce('V2_2_1/eMSP/Server/Locations/Evses/evseGetResponse.schema.json', $json);
