...
namespace Tests\Chargemap\OCPI\Versions\V2_2_1\Server\Emsp\Credentials\Put;

use Chargemap\OCPI\Versions\V2_2_1\Common\Factories\CredentialsFactory;
use Chargemap\OCPI\Versions\V2_2_1\Server\Emsp\Credentials\Put\OcpiEmspCredentialsPutResponse;
use PHPUnit\Framework\TestCase;
use Tests\Chargemap\OCPI\OcpiTestCase;
use Tests\Chargemap\OCPI\Versions\V2_2_1\Common\Models\CredentialsTest;

/**
 * @covers \Chargemap\OCPI\Versions\V2_2_1\Server\Emsp\Credentials\Put\OcpiEmspCredentialsPutResponse
 */
class ResponseConstructionTest extends TestCase
{
    public function testShouldConstructCorrectly(): void
    {
        ...
        OcpiTestCase::coerce('V2_2_1/eMSP/Server/Credentials/credentialsPostResponse.schema.json', $json);
