...
namespace Tests\Chargemap\OCPI\Versions\V2_2_1\Server\Sender\Tokens\Get;

use Chargemap\OCPI\Versions\V2_2_1\Common\Factories\TokenFactory;
use Chargemap\OCPI\Versions\V2_2_1\Server\Sender\Tokens\Get\SenderTokenGetRequest;
use Chargemap\OCPI\Versions\V2_2_1\Server\Sender\Tokens\Get\SenderTokenGetResponse;
...
/**
 * @covers \Chargemap\OCPI\Versions\V2_2_1\Server\Sender\Tokens\Get\OcpiEmspTokenGetResponse
 */
class ResponseConstructionTest extends TestCase
{
    public function testShouldReturnEmptyArrayWithoutTokens(): void
    {
        $response = new SenderTokenGetResponse(self::getRequest(), 0, 10);
        $responseInterface = $response->getResponseInterface();
        $this->assertSame([], json_decode($responseInterface->getBody()->getContents(), true)['data']);
    }

    private function getRequest(): SenderTokenGetRequest
    {
        return new SenderTokenGetRequest(
