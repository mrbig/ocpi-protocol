...
use Chargemap\OCPI\Versions\V2_2_1\Server\Sender\Locations\Evses\Connectors\Get\SenderConnectorGetResponse;
use PHPUnit\Framework\TestCase;
use Tests\Chargemap\OCPI\OcpiTestCase;
use Tests\Chargemap\OCPI\Versions\V2_2_1\Common\Models\ConnectorTest;

/**
 * @covers \Chargemap\OCPI\Versions\V2_2_1\Server\Emsp\Locations\Sender\Connectors\Get\SenderConnectorGetResponse
 */
class ResponseConstructionTest extends TestCase
{
    ...
    public function testShouldSerializeConnectorCorrectlyWithFullPayload(string $payload)
    {
        ...
        $response = new SenderConnectorGetResponse($connector);
        ...
        OcpiTestCase::coerce('V2_2_1/eMSP/Server/Locations/Evses/Connectors/connectorGetResponse.schema.json', $json);
