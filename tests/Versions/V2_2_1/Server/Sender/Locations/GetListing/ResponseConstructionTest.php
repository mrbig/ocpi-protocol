...
namespace Tests\Chargemap\OCPI\Versions\V2_2_1\Server\Sender\Locations\GetListing;

use Chargemap\OCPI\Versions\V2_2_1\Common\Factories\LocationFactory;
use Chargemap\OCPI\Versions\V2_2_1\Server\Sender\Locations\GetListing\SenderLocationGetListingRequest;
use Chargemap\OCPI\Versions\V2_2_1\Server\Sender\Locations\GetListing\SenderLocationGetListingResponse;
...
/**
 * @covers \Chargemap\OCPI\Versions\V2_2_1\Server\SenderLocationsGetListing\SenderLocationGetListingResponse
 */
class ResponseConstructionTest extends TestCase
{
    public function testShouldReturnEmptyArrayWithoutTokens(): void
    {
        $response = new SenderLocationGetListingResponse(self::getRequest(), 0, 10);
        $responseInterface = $response->getResponseInterface();
        $this->assertSame([], json_decode($responseInterface->getBody()->getContents(), true)['data']);
    }

    private function getRequest(): SenderLocationGetListingRequest
    {
        return new SenderLocationGetListingRequest(
