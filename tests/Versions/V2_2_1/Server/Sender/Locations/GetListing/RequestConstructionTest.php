...
/**
 * @covers \Chargemap\OCPI\Versions\V2_2_1\Server\Sender\Locations\GetListing\SenderLocationGetListingRequest
 */
class RequestConstructionTest extends OcpiTestCase
{
    public function testShouldConstructWithoutDates(): void
    {
        ...
        $request = new SenderLocationGetListingRequest($serverRequestInterface);
    ...
    public function testShouldThrowWithInvalidDates(): void
    {
        ...
        new SenderLocationGetListingRequest($serverRequestInterface);
    }
}
