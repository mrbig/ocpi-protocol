...
/**
 * @covers \Chargemap\OCPI\Versions\V2_2_1\Client\Credentials\Post\PostCredentialsRequest
 */
class PostCredentialsRequestTest extends TestCase
{
    public function getPostServerRequestInterfaceData(): iterable
    {
    ...
    /**
     * @dataProvider getPostServerRequestInterfaceData()
     * @throws InvalidPayloadException
     * @throws JsonException
     */
    public function testPostServerRequestInterface(string $payload): void
    {
