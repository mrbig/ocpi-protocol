...
/**
 * @covers \Chargemap\OCPI\Versions\V2_1_1\Server\Cpo\Locations\GetListing\OcpiCpoLocationGetListingRequest
 */
class RequestConstructionTest extends OcpiTestCase
{
    public function testShouldConstructWithoutDates(): void
    {
        ...
        $request = new OcpiCpoLocationGetListingRequest($serverRequestInterface);
    ...
    public function testShouldThrowWithInvalidDates(): void
    {
        ...
        new OcpiCpoLocationGetListingRequest($serverRequestInterface);
    }
}
