...
use Chargemap\OCPI\Versions\V2_1_1\Server\Cpo\Locations\Evses\Get\OcpiCpoEvseGetResponse;
...
/**
 * @covers \Chargemap\OCPI\Versions\V2_1_1\Server\Emsp\Locations\Sender\Get\OcpiCpoEvseGetResponse
 */
class ResponseConstructionTest extends TestCase
{
    ...
    public function testShouldSerializeLocationCorrectlyWithFullPayload(string $payload)
    {
        ...
        $response = new OcpiCpoEvseGetResponse($evse);
        ...
        OcpiTestCase::coerce('V2_1_1/CPO/Locations/Evses/evseGetResponse.schema.json', $json);
