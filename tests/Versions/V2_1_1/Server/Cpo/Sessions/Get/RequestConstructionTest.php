...
/**
 * @covers \Chargemap\OCPI\Versions\V2_1_1\Server\Cpo\Sessions\Get\OcpiCpoSessionGetListingRequest
 */
class RequestConstructionTest extends OcpiTestCase
{
    public function testShouldConstructWithoutDates(): void
    {
        ...
        $request = new OcpiCpoSessionGetListingRequest($serverRequestInterface);
    ...
    public function testShouldThrowWithInvalidDates(): void
    {
        ...
        new OcpiCpoSessionGetListingRequest($serverRequestInterface);
    }
}
