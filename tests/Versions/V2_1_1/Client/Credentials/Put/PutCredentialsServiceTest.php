...
namespace Tests\Chargemap\OCPI\Versions\V2_1_1\Client\Credentials\Put;
...
/**
 * @covers \Chargemap\OCPI\Versions\V2_1_1\Client\Credentials\Put\PutCredentialsService
 */
class PutCredentialsServiceTest extends OcpiResponseTestCase
{

    /**
     * @var PutCredentialsService|MockObject
     */
    private $service;
    ...
    public function setUp(): void
    {
        ...
        $this->service = $this->getMockBuilder(PutCredentialsService::class)
    ...
    {
        foreach (scandir(__DIR__ . '/Payloads/PutCredentialsService/') as $filename) {
            if ($filename !== '.' && $filename !== '..') {
                yield $filename => [
                    'payload' => file_get_contents(__DIR__ . '/Payloads/PutCredentialsService/' . $filename),
                ];
            }
        }
    }
    ...
    public function testHandle(string $payload): void
    {
        ...
        $request = $this->createMock(PutCredentialsRequest::class);
